...
//Active Treatment constants
const double PROB_ACTIVE_TREATMENT_SUCCESS    = 0.9;    // probability that treatment of active TB is successful
const double ACTIVE_TREATMENT_COST_NOHOSPITAL = 6000;   // 9 month medications
const double ACTIVE_TREATMENT_COST_HOSPITAL   = 20000;  // 9 month medications + hospitalizations
const double PROB_HOSPITAL                    = 0.49;   // probability that active TB case requires hospitalizations
const double COST_PER_ACTIVE_CURE_NOHOSPITAL  = ACTIVE_TREATMENT_COST_NOHOSPITAL / PROB_ACTIVE_TREATMENT_SUCCESS;
